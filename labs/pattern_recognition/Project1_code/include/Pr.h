...
Matrix kmeans(Matrix &, Matrix &, int);
Matrix winnerTakesAll(Matrix &, Matrix &, int, double);
Matrix kohonenMap(Matrix &, Matrix &, int, int, int, double, double);

// classifier fusion
Matrix bks(Matrix &, Matrix &,Matrix &,Matrix &, int);
